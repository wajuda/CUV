...
logger.info(f"Dataset {diffusion_args.dataset} loaded successfully with observation_dim={observation_dim}, action_dim={action_dim}.")
...
policy_config = utils.Config(
    ...
    normalizer = dataset.normalizer, 
    sample_fn = diffusion_args.sample_fn,
